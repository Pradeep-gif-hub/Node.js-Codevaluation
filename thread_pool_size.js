...
process.env.UV_THREADPOOL_SIZE=8; // to increase the threadpool size so that more numbe rof 
// codes can be executes paralley smae time to reduce the time of execution 
...
const start=Date.now(); 
// const maxcall=5; // it has 4 threads like only 4 calls can be executed at same time
const maxcall=5;
